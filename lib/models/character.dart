...
List characters = [
  Character(
      name: "Kevin",
      imagePath: "lib/assets/images/Kevin_minions.png",
      description:
  ...
  Character(
      name: "Agnes",
      imagePath: "lib/assets/images/Agnes_gru.png",
      description:
  ...
  Character(
      name: 'Edith',
      imagePath: 'lib/assets/images/edith.png',
      description:
          'She shares many traits with Gru, being very destructive, tomboyish and sports a macabre sense of humor. In the beginning, she is reserved and quiet - being opposed to the idea of being an adopted child.',
      colors: [
        Colors.pinkAccent,
  ...
  Character(
      name: 'Gru',
      imagePath: 'lib/assets/images/gru.png',
      description:
          'Gru is a 57-year-old bald man who used to be the world #1 villain. His plan involved stealing the moon, which would be the crime of the century. When he saw Margo and her little sisters go inside Vectors lair, Gru decided to adopt them so they could sneak into Vectors lair and take the shrink ray Vector stole from Gru who stole it from an Asian laboratory',
